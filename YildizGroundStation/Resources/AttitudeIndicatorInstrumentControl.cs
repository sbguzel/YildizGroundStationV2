...
namespace YildizGroundStation
{
    class AttitudeIndicatorInstrumentControl : InstrumentControl
    {
        ...
        // Images
        Bitmap bmpCadran = new Bitmap(YildizGroundStation.Resource.Horizon_Background);
        Bitmap bmpBoule = new Bitmap(YildizGroundStation.Resource.Horizon_GroundSky);
        Bitmap bmpAvion = new Bitmap(YildizGroundStation.Resource.Maquette_Avion);
