...
namespace YildizGroundStation
{
    class HeadingIndicatorInstrumentControl : InstrumentControl
    {
        ...
        // Images
        Bitmap bmpCadran = new Bitmap(YildizGroundStation.Resource.HeadingIndicator_Background);
        Bitmap bmpHedingWeel = new Bitmap(YildizGroundStation.Resource.HeadingWeel);
        Bitmap bmpAircaft = new Bitmap(YildizGroundStation.Resource.HeadingIndicator_Aircraft);        
